...
/*
 * Copyright (C) Mason Austin Green
...
intable :: proc(t: Table, r: rune) -> bool {
 if r < t[0].first do	return false
...
wcwidth :: proc(ucs: rune) -> int {
 ...
 if ucs < 32 || (0x07F <= ucs && ucs < 0x0A0) do return -1

 // Combining characters with zero width.
 if intable(ZERO_WIDTH, ucs) do return 0
